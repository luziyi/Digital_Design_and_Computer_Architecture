...
-- Date        : Sun Jun 30 15:17:38 2024
-- Host        : TommyGong running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               E:/DDCA/lab4/MiniMIPS32_stu/MiniMIPS32/MiniMIPS32.srcs/sources_1/ip/inst_rom/inst_rom_sim_netlist.vhdl
-- Design      : inst_rom
...
entity inst_rom_dist_mem_gen_v8_0_13 is
  ...
  attribute C_ADDR_WIDTH of inst_rom_dist_mem_gen_v8_0_13 : entity is 8;
  attribute C_DEFAULT_DATA : string;
  attribute C_DEFAULT_DATA of inst_rom_dist_mem_gen_v8_0_13 : entity is "0";
  attribute C_DEPTH : integer;
  attribute C_DEPTH of inst_rom_dist_mem_gen_v8_0_13 : entity is 256;
...
begin
  ...
  spo(30) <= \^spo\(21);
  spo(29) <= \^spo\(29);
  spo(28 downto 27) <= \^spo\(9 downto 8);
  spo(26) <= \^spo\(21);
  spo(25) <= \^spo\(25);
  spo(24) <= \^spo\(8);
